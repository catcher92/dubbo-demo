...
CREATE TABLE `biz_department` (
  ...
  `delete_status` int(1) DEFAULT NULL COMMENT '删除状态 0未删除，1已删除',
...
CREATE TABLE `biz_user` (
  ...
  `lock_status` int(1) DEFAULT NULL COMMENT '锁定状态 0未锁定，1已锁定',
  `delete_status` int(1) DEFAULT NULL COMMENT '删除状态 0未删除，1已删除',
  `create_date` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `update_date` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `biz_user_dept_role_link` (
  ...
  `is_parttime` int(1) DEFAULT NULL COMMENT '是否兼职 0主职，1兼职',
  `delete_status` int(1) DEFAULT NULL COMMENT '删除状态 0未删除，1已删除',
  `create_date` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` varchar(50) DEFAULT NULL COMMENT '创建人',
  `update_date` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
